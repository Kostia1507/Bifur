    ...
    "Ігри":
        [
            ...
            },
            {
                "name": ">puzzle15",
                "aliases": ['>15'],
                "description": "Гравець отримує доску 4х4 випадково заповнену цифрами від 1 до 15. Одна клітинка "
                               "залишається пустою\n" +
                               "За хід можна поміняти місцями пусту клітинку та любу сусідню\n" +
                               "Ціль гри: Поставити всі цифри в порядку від 1 до 15, і в правому нижньому кутку "
                               "залишити пусту\n" +
                               "Всі стрілки вказують напрям від пустої клітинки до сусіда\n>" +
                               "Тому, щоб поміняти пусту клітинку і цифру над нею, натисніть стрілку вгору"
            },
            {
                "name": ">quiz",
                "aliases": [],
                "description": "Запускаю вікторину в якій вам треба вибирати що зображено на фотографії"
            },
            {
                "name": ">mquiz [бали] [згадування]",
                "aliases": [],
                "description": "Зіграйте в вікторину разом з друзями.\n" +
                               "Грайте до вказаної кількості балів зі всіми кого згадали в повідомленні\n" +
                               "За неправильну відповідь учасник отримує -2 бали і більше не може відповідати на це "
                               "питання"
            }
        ],
    "Калькулятор":
