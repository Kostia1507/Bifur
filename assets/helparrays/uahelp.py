    ...
    "Команди шаблонів":
        [
            ...
            },
            {
                "name": ">pat [url]",
                "aliases": [],
                "description": "створює GIF файл з вашим файлом. Можна прикріпляти картинку до повідомлення замість посилання"
            },
            {
                "name": ">vibe [url]",
                "aliases": [">viber"],
                "description": "створює GIF файл з вашим файлом. Можна прикріпляти картинку до повідомлення замість посилання. >viber розмістить кота з правої сторони"
            },
            {
                "name": ">slap [url]",
                "aliases": [],
            ...
            },
            {
                ...
                "aliases": [],
                "description": "Перетворює вашу картинку в постер. Показник color контролює кількість кольорів в палітрі.\n"
                               "Використовуйте більше значення color для відображення більшої кількості кольорів.\n"
                               "Рекомендую починати з показника 12."
            },
            {
                "name": ">oil [url], >pencil [url], >watercolor [url]",
                "aliases": [],
                "description": "Намагається створити вигляд мов картина намальована олійними фарбами, олівцем чи акварелю відповідно."
            },
            {
                "name": ">rip [url чи згадування]",
                "aliases": [],
                "description": "Переводить картинку в чорно білий профіль та добавляє свічку"
            },
            {
                "name": ">vietnam [url чи згадування]",
                "aliases": [],
                "description": "Добавляє на фон фото з війни у В'єтнамі."
            },
        ],
    ...
    "Ігри":
        [
            ...
            },
            {
                "name": ">rps [згадування]",
                "aliases": [],
                "description": "запускає гру в Камінь-Ножиці-Папір проти вибраного користувача"
            },
            {
            ...
            },
            {
                "name": ">wordle [мова]",
                "aliases": [],
                "description": "Wordle це гра в якій потрібно вгазади загадане слово з 5 букв за 6 спроб.\n"
                               "Зеленим кольором будуть відмічені букви, що співпадають з буквою в загаданому слові.\n"
                               "Жовтим кольором відмічені ті що також є в загадоному слові, але знаходяться в іншій клітинці.\n"
                               "Щоб зіграти українською мовою, введіть команду >wordle ua\n"
            },
            {
                "name": ">2048 [розмір]",
                "aliases": ["game2048"],
                "description": "Починає гру в 2048. Розмір поля може бути від 2 до 5.\n"
            },
        ],
    "Калькулятор":
        [
            {
                ...
                "description": "Вирішує математичний вираз\n" +
                               ...
                               "a log b - логарифм числа b з основою a\n"
                               "ln a - натуральний логарифм числа a"
            },
            {
    ...
    "Налаштування серверу":
        [
            ...
            },
            {
                ...
                "description": "вернути префікс за замовчанням"
            },
            {
            ...
            },
            {
                "name": ">setcmd [channel]",
                "aliases": [],
                "description": "створює нову команду в вибранному каналі"
            },
            {
                "name": ">editcmd [channel] [id]",
                "aliases": [],
                "description": "редагує команду з вказаним [id] у вибраному каналі. Шукайте ID завдяки >getcmds"
            },
            {
                "name": ">getcmds [channel]",
                "aliases": [],
                "description": "список всіх команд в вибранному каналі"
            },
            {
                "name": ">delcmd [channe] [id]",
                "aliases": [],
                "description": "видаляє команду за ID. Взнати ID можна завдяки >getcmds"
            },
        ],
