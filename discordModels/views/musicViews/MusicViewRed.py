...
class MusicViewRed(discord.ui.View):
    ...
    @discord.ui.button(label="", style=discord.ButtonStyle.red, emoji=config.shuffleEmoji, row=1)
    ...
    @discord.ui.button(label="", style=discord.ButtonStyle.red, emoji=config.repeatEmoji, row=1)
    ...
    @discord.ui.button(label="", style=discord.ButtonStyle.red, emoji=config.volumeDownEmoji, row=2)
    ...
    @discord.ui.button(label="", style=discord.ButtonStyle.gray, emoji=config.stopEmoji, row=2)
    ...
    @discord.ui.button(label="", style=discord.ButtonStyle.red, emoji=config.volumeUpEmoji, row=2)
